...
local smoothingFactor = 0.1  -- Smoothing for target adjustments
...
local function smoothMouseMovement(targetPos)
    ...
    local newX = currentX + (targetPos.X - currentX) * smoothingFactor
    local newY = currentY + (targetPos.Y - currentY) * smoothingFactor
